...
/**
 * <b>ExamEventDate est la classe filtrant les ExamEvent partageant la même date de passage que l'ExamEvent référent</b>
 * @see ExamEvent
 * @author Schlange
 *
 */
public class ExamEventDate implements CritereExamEvent {
	...
	/**
	 * Création du filtre à partir d'une nouvelle date
	 * @param dat
	 */
	...
	/**
	 * Filtrage de la list partageant la même date de passage que l'ExamEvent de référence
	 */
